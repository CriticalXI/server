...
-- Fishing area names for each Manaclipper destination, the Purgonorgo Isle crossing fishes the same both ways
local routeNames =
{
    [dest.DHALMEL_ROCK]      = 'dhalmel_rock',
    [dest.MALIYAKALEYA_REEF] = 'maliyakaleya_reef',
    [dest.PURGONORGO_ISLE]   = 'purgonorgo_isle',
    [dest.SUNSET_DOCKS]      = 'purgonorgo_isle',
}

-- The fishing area name for the Manaclipper's current route
