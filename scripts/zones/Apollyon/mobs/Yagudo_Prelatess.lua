...
entity.onMobSpellChoose = function(mob, target, spellId)
    local spellList =
    {
        ...
        [ 4] = { xi.magic.spell.SLEEPGA_II,   target, false, xi.action.type.ENFEEBLING_TARGET, xi.effect.SLEEP_I,   2, 100 },
        ...
        [ 7] = { xi.magic.spell.POISONGA_II,  target, false, xi.action.type.ENFEEBLING_TARGET, xi.effect.POISON,    1, 100 },
        [ 8] = { xi.magic.spell.BIO_II,       target, false, xi.action.type.ENFEEBLING_TARGET, xi.effect.BIO,       2, 100 },
        [ 9] = { xi.magic.spell.FIRE_IV,      target, false, xi.action.type.DAMAGE_TARGET,     nil,                 0, 100 },
        [10] = { xi.magic.spell.BLIZZARD_IV,  target, false, xi.action.type.DAMAGE_TARGET,     nil,                 0, 100 },
        [11] = { xi.magic.spell.AERO_IV,      target, false, xi.action.type.DAMAGE_TARGET,     nil,                 0, 100 },
        [12] = { xi.magic.spell.WATER_IV,     target, false, xi.action.type.DAMAGE_TARGET,     nil,                 0, 100 },
        [13] = { xi.magic.spell.THUNDER_IV,   target, false, xi.action.type.DAMAGE_TARGET,     nil,                 0, 100 },
